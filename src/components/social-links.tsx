...
/**
 * Contact, such as it is. A form on a personal site collects spam and little
 * else, and a page holding two links is a page holding two links — so these sit
